...
void initParticles(int i)
 ...
 //cout<<"inside init";
    ...
    par_sys[i].xpos = (float)( (rand() % 801) - 100)/10;
    par_sys[i].ypos = (float)( (rand() % 101) - 100)/1000;
    par_sys[i].zpos = (float) ((rand() % 501) - 10)/10;
    ...
    if (par_sys[loop].alive == true)
    {
     ...
     //glDisable(GL_TEXTURE_2D);
      ...
      glBegin(GL_LINES);
        ...
        glVertex3f(x, y-0.45, z+39);
        //glVertex3f(x/1000, (y+1.5)/1000, z/1000);
      glEnd();
      y=y*-1;
      
      
      glBegin(GL_LINES);
        glVertex3f(x+0.05, y-0.3, z+39);
        glVertex3f(x+0.05, y-0.4, z+39);
      glEnd();
...
void display(void)
{
	...
	case 2:scene2(false, 0.3,0.61,0.22, 0.4,0.66,0.22);	//summer
			rain=false;
			snow=false;
			break;
			
	case 3:scene2(false, 0.918,0.516,0.0,0.4,0.66,0.22);	//autumn
			rain=false;
			snow=false;
			break;
